module ActiveModel
  class SerializerJsonapi < Serializer; end
end
...
#Added for implicit serializer testing
class UserJsonapiSerializer < Jsonapi::UserSerializer
  self.jsonapi_format = true
end
class PostJsonapiSerializer < Jsonapi::PostSerializer; end
class UserJsonapi < Jsonapi::User; end
class PostJsonapi < Jsonapi::Post; end
